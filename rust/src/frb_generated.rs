...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1496024253;
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__file_info__get_file_info_impl(ptr, rust_vec_len, data_len),
        2 => wire__crate__api__file_meta__get_image_meta_info_impl(ptr, rust_vec_len, data_len),
        3 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        5 => wire__crate__api__simple__set_atime_impl(ptr, rust_vec_len, data_len),
        6 => wire__crate__api__simple__set_ctime_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__api__simple__set_mtime_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
