...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "caseFile": MessageLookupByLibrary.simpleMessage("区分文件"),
    ...
    "deleteTipButton1": MessageLookupByLibrary.simpleMessage("我已知晓，不再提醒"),
    "deleteTipButton2": MessageLookupByLibrary.simpleMessage("我已知晓"),
    "deleteTipMessage": MessageLookupByLibrary.simpleMessage(
      "该操作会将文件从系统中删除，且无法恢复。取消操纵请点击弹窗外面的区域。",
    ),
    ...
    "letters": MessageLookupByLibrary.simpleMessage("字母"),
    ...
    "openError": MessageLookupByLibrary.simpleMessage("打开文件所在文件夹失败"),
