...
import 'package:once_power/view/notification/animation.dart';
import 'package:once_power/view/notification/content.dart';
...
class NotificationInfo {
  ...
  void show() {
    ...
    BotToast.showCustomNotification(
      toastBuilder: (cancelFunc) => NotificationContent(
