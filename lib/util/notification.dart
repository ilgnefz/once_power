...
void showDateWarningNotification() {
  NotificationInfo(
    type: NotificationType.warning,
    title: tr(AppL10n.warnLabel),
    message: tr(AppL10n.warnDate),
    time: 5,
  ).show();
}
...
void showLogDecodeErrorNotification() {
  NotificationInfo(
    type: NotificationType.error,
    title: tr(AppL10n.errCSV1),
    message: tr(AppL10n.errLog),
    time: 5,
  ).show();
}
...
void showCreateLogError(String message) {
  NotificationInfo(
    type: NotificationType.error,
